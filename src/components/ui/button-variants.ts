    ...
    compoundVariants: [
      {
        variant: "cta",
        size: "default",
        class: "h-12 min-h-12 rounded-2xl px-4 text-base font-semibold [&_svg]:size-5",
      },
      {
        variant: "cta",
        size: "sm",
        class: "h-8 min-h-8 rounded-2xl px-3 text-sm font-semibold gap-1.5 [&_svg]:!size-4",
      },
      {
        variant: "cta",
        size: "dense",
        class: "h-7 min-h-7 rounded-xl px-2 text-xs font-semibold gap-1.5 [&_svg]:!size-3.5",
      },
      {
        variant: "cta",
        size: "icon",
